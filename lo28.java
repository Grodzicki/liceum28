...
//==========================================================     
  public static void init(Dimension w)  //wywolac: lo28.init(getSize());
   {  
      ...
      //setBackground(lo28.tlo);w metodzie paint() lub init()     
	}
//---------------------------------------------------------
   public static pkt2d r2(int x,int y)
   {    
	  return(new pkt2d(((double)x-lo28.sx)/20.0,(lo28.sy-(double)y)/20.0));
	 } 
//-------------------------------------------------	     
...
//--------------------------------------------------------- 
  public static void czysc(Graphics g,Color kolor)
   ...
   {
     g.setColor(kolor);
     g.fillRect(0,0,2*(int)lo28.sx,2*(int)lo28.sy); 
   }
//------------------------------------------------------
...
//--------------------------------------------------------- 
 ...
 public static void oznacz(Graphics g,pkt2d x,String zd)
   {
	  lo28.kropka(g,x,Color.red);
    g.setColor(Color.black);
		lo28.pisz(g,lo28.p2d(x.x+0.2,x.y+0.2),zd);
  }
//---------------------------------------------------------------------------
